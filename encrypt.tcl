...
if {$argc != 3} {
    ...
    puts "Syntax: encrypt.tcl file key keep_old_file";
    exit;
}
...
for {set i 4} {$i < 16} {incr i} {
    lappend iv_rand [format %02x [expr int(rand() * 0x100)]];
...
for {set i 0} {$i < $pt_num_blocks} {incr i} {
